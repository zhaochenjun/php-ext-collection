...
/* {{{ ARG_INFO
 */
ZEND_BEGIN_ARG_INFO_EX(collection_common_arginfo, 0, 0, 0)
...
zend_function_entry collection_methods[] = {
        ...
        PHP_ME(vtiful_collection, collapse,        collection_common_arginfo,         ZEND_ACC_PUBLIC)
        PHP_ME(vtiful_collection, count,           collection_common_arginfo,         ZEND_ACC_PUBLIC)
        PHP_ME(vtiful_collection, toArray,         collection_common_arginfo,         ZEND_ACC_PUBLIC)
        ...
        PHP_ME(vtiful_collection, flip,            collection_common_arginfo,         ZEND_ACC_PUBLIC)
        ...
        PHP_ME(vtiful_collection, isEmpty,         collection_common_arginfo,         ZEND_ACC_PUBLIC)
        PHP_ME(vtiful_collection, isNotEmpty,      collection_common_arginfo,         ZEND_ACC_PUBLIC)
        PHP_ME(vtiful_collection, keyBy,           collection_key_by_arginfo,         ZEND_ACC_PUBLIC)
        PHP_ME(vtiful_collection, keys,            collection_common_arginfo,         ZEND_ACC_PUBLIC)
